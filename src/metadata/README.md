 ...
 * [alnt.yml](alnt.yml)
     * Determines how your purl.obolibrary.org/obo/alnt/ redirects will be handled
     ...
     * Paste in the contents of [alnt.yml](alnt.yml)
 ...
 * [alnt.md](alnt.md)
     ...
     * Paste in the contents of [alnt.md](alnt.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
